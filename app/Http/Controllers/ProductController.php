...
class ProductController extends Controller
{
    ...
    public function detail_product($product_id)
    {
       ...
       return view('pages.product.show_detail')->with('category',$cate_product)->with('brand',$brand_product)->with('product_detail',$detail_product)->with('relate',$related_product);
    }
}
